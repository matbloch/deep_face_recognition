...
def load_pretrained_model():
    ...
    model = os.path.join(pycaffe_dir, "models", "disc_feature_approach_face_model.caffemodel")
    ...
    # classifier.
    model_definitions = os.path.join(pycaffe_dir, "models", "disc_feature_approach_face_deploy.prototxt")
...
def main(argv):
    ...
    print "--- Feature vector dimension: {}".format(len(predictions[0]))
    # Save
