...
def main(argv):
    ...
    parser.add_argument(
        ...
        default=os.path.join(pycaffe_dir, "models",
                "LightenedCNN_C_deploy_reduced.prototxt"),
        help="Model definition file."
    )
    parser.add_argument(
        "--pretrained_model",
        default=os.path.join(pycaffe_dir, "models",
                "LightenedCNN_C.caffemodel"),
    ...
    # Classify.
    i_96 = [caffe.io.load_image("input_96_gray.png")]
    i_128 = [caffe.io.load_image("input_128_gray.png")]
    i_256 = [caffe.io.load_image("input_256_gray.png")]
